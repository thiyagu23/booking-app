      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          ...
          <span className="hotelPriceHighlight">
            Book a stay over ₹1,199 at this property and get a free airport taxi
          </span>
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              ...
              <p className="hotelDesc">
                Located a 5-minute walk from the airport, Tower Street
                Apartments has accommodations with air conditioning and free
                ...
                Hall, Main Market Square and Town Hall Tower.The property offers
